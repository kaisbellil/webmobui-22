...
import { renderSongsSection, renderSongsSearchSection, renderSongsFavoriteSection } from './sections/songs'
...
function displaySection() {
  ...
  renderSongsSearchSection(decodeURIComponent(sectionSplit[1]))
    break;

    case '#favorites':
      toggleSection('#songs')
      renderSongsFavoriteSection()
    break;
